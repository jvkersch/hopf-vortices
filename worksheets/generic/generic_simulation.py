...
s.sigma = 0.10
s.run_simulation(h = 0.01, tmax=200, numpoints=1000, sim='sphere-midpoint')
s.post_process()
...
s.load_initial_conditions('random40.mat')
s.sigma = 0.10
s.run_simulation(h = 0.01, tmax=200, numpoints=1000, sim='rk4')
s.post_process()
...
s.load_initial_conditions('random40.mat')
s.sigma = 0.10
s.run_simulation(h = 0.01, tmax=200, numpoints=1000, sim='midpoint')
s.post_process()
...
s.load_initial_conditions('random40.mat')
s.sigma = 0.10
s.run_simulation(h = 0.01, tmax=200, numpoints=1000, sim='lie-poisson')
s.post_process()
