...
s.post_process()
s.save_results('data/collapse3_lp_sigma10_sim.mat')

# Midpoint integration, medium regularization
s.sigma = 0.10
s.run_simulation(tmax=15, numpoints=75, sim='midpoint')
s.post_process()
s.save_results('data/collapse3_mp_sigma10_sim.mat')


# Output for plotting 
s.sigma = 0.10
s.run_simulation(tmax=10, numpoints=1000, h=0.01, 
